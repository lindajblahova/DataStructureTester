...
namespace structures
{
	...
	Array<T>::Array(const Array<T>& other) :
		vector_(new Vector(*(other.vector_))), // *objekt.pointer je v pohode *pointer.objekt nie, bud () alebo ->
		size_(other.size_)
	{
	}
	...
	Array<T>& Array<T>::operator=(const Array<T>& other)
	{
		...
		if (this != &other)
		{
			// nemozem proradovat rozne velkosti
	...
	{
		// polia su rovnake ked su ich vektory rovnake
	...
	{
		// mapujes prvky array na prvky vektora, pozor na bazu
